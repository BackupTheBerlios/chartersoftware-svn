<?php
    echo $form->create('Flugplatz', array('action' => 'edit', 'class'=>'yform columnar'));
    ...
    echo $form->input('Flugplatz.iata', array('div'=>'type-text','error'=>array('required'=>'Bitte internationale Abkürzung eingeben','length'=>'Das Feld darf nicht laenger als 9 Zeichen sein')));
