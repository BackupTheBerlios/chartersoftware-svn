...
<?php
    ...
    echo $form->input('Flugplatz.internatKuerzel', array('error'=>array('required'=>'Bitte internationale Abk�rzung eingeben','length'=>'Das Feld darf nicht laenger als 4 Zeichen sein')));
