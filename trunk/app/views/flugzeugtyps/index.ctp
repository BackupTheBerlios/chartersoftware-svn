...
<?php 
	echo $html->link('Neuen Flugzeugtyp anlegen','/flugzeugtyps/add');
    echo $html->tag('table'); 
    ...
    foreach ($flugzeugtyps as $zeile):
	    echo $html->tableCells( array(
        	...
        	$html->link('Ändern', "/flugzeugtyps/edit/{$zeile['Flugzeugtyp']['id']}"),
        	$html->link('Löschen', "/flugzeugtyps/delete/{$zeile['Flugzeugtyp']['id']}", null, 'Sind Sie sich sicher?' )
    	));
